...
if (document.querySelector('.tips_slider__body')) {
...
window.onload = function () {
    ...
    function documentActions(e) {
        ...
        } else if (!targetElement.closest('.search-form') && document.querySelector('.search__form._active')) {
            document.querySelector('.search__form._active').classList.remove('_active')
        }
...
`;
		...
		<div class="item-product__actions actions-product">
			<div class="actions-product__body">
				...
				<a href="${productShareUrl}" class="actions-product__link btn _icon-share">Share</a>
				<a href="${productLikeUrl}" class="actions-product__link btn _icon-favorite">Like</a>
			</div>
		</div>
	`;
    ...
    function updateCart(productButton, productId, productAdd = true) {
        const cart = document.querySelector('.cart-header')                         // Корзина товаров
        const cartIcon = cart.querySelector('.cart-header__icon')
        const cartQuantity = cartIcon.querySelector('span')                          // span с количеством товаров
        const cartProduct = document.querySelector(`[data-cart-pid="${productId}"]`) // Карточка товара в корзине
        const cartList = document.querySelector('.cart-list')                        // Список товаров в корзине
